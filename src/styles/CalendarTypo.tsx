...
export const CalendarTypography = ({
	...
	const roleStyles = {
		...
		period: { color: "text.secondary", fontWeight: "500", fontSize: 16 },
		button: { color: "white", fontWeight: "400", fontSize: 16 },
		cardtitle: { color: "text.primary", fontWeight: "700", fontSize: 18 },
		cardsection: { color: "text.primary", fontWeight: "500", fontSize: 16 },
